        ...
        <div className ="auth__form-container_fields">
            <div className="auth__form-container_fields-content">
                ...
                <form onSubmit={()=>{}}>
                    ...
                    {isSignup && (
                        <div className="auth__form-container_fields-content_input">
                            <label  htmlFor="phonenumbwr">Số Điện Thoại</label>
                            <input name="phonenumber" type="text" placeholder="05646404xx" onChange={handleChange}
                            required />
                        </div>
                    )}
                    {isSignup && (
                    ...
                    {isSignup && (
                        <div className="auth__form-container_fields-content_input">
                            ...
                            <input name="password" type="text" placeholder="Mật khẩu" onChange={handleChange}
                            required />
                        </div>
                    )}
                    {isSignup && (
